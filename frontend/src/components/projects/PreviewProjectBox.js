...
function PreviewProjectBox({title, file, github, description, skills, frontend, backend}) {
  return (
<div className="Box">
      <div className="Box_image" style={{ backgroundSize: 'cover',  backgroundRepeat: 'no-repeat', backgroundPosition: 'center', height: '300px', width: '400px'}}>
         <img src={`data:image/png;base64,${file}`} style={{padding: '15px',paddingTop: '40px',  width:'400px', height: '100%'}}/>
      </div>
